...
export class MyAccountComponent implements OnInit {
    ...
    constructor(private httpRequest: HTTPRequestService, private authentificationService: AuthentificationService, private sanitizer: DomSanitizer, private navBarStateService: NavBarStateService) {
